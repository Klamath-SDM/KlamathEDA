...
unique_gage_shas <- unique_gage_shasta |> 
  st_as_sf(coords = c("longitude", "latitude"), crs = 4326)

leaflet(unique_gage_shas) |> 
  addTiles() |> 
    addCircleMarkers(
    popup = ~paste0("Stream name: ", stream, "<br>Gage Number: ", gage_number, "<br>Max Date: ", max_date, "<br>Min Date: ", min_date)
  )
...
unique_gage_data_salmon <- unique_gage_data_salmon |> 
  st_as_sf(coords = c("longitude", "latitude"), crs = 4326)

leaflet(unique_gage_data_salmon) |> 
  addTiles() |> 
  addCircleMarkers(popup = ~paste0("Stream name: ", stream, "<br>Gage Number: ", gage_number, "<br>Max Date: ", max_date, "<br>Min Date: ", min_date))
```
...
unique_gage_data_sprague <- unique_gage_data_sprague |> 
  st_as_sf(coords = c("longitude", "latitude"), crs = 4326)

leaflet(unique_gage_data_sprague) |> 
  addTiles() |> 
  addCircleMarkers(popup = ~paste0("Stream name: ", stream, "<br>Gage Number: ", gage_number, "<br>Max Date: ", max_date, "<br>Min Date: ", min_date))
```
...
unique_gage_or <- unique_gage_or |> 
  st_as_sf(coords = c("longitude", "latitude"), crs = 4326)

leaflet(unique_gage_or) |> 
  addTiles() |> 
    addCircleMarkers(
    popup = ~paste0("Stream name: ", stream, "<br>Gage Number: ", gage_number, "<br>Max Date: ", max_date, "<br>Min Date: ", min_date)
  )
